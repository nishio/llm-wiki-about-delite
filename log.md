...
[tools/fetch_udagawa.py](tools/fetch_udagawa.py) で 3 バッチ目を取得。**累計 1,505 件 / 本文あり 608 件 (40%)**。新たに 171 件の本文ありを発見。発見した長文越省は前回までよりさらに踏み込んでおり、政治論や市場戦略の本格論考が多数浮上した。

### 新規 concept ページ（4 ページ）

- [自由](wiki/concepts/utagawa/自由.md) — 本人輪郭 [K#F85E/046C](https://dlt.kitetu.com/KNo.F85E/046C)（2012-08-24）から。「自らに由る」の意で、self-cause（causa sui）に通じる **第三の意味** を持つ日本固有の概念として扱い、外国語に翻訳する際は `jiyu` とそのまま日本語のローマ字表記にする。これは [希哲館訳語](wiki/concepts/utagawa/希哲館訳語.md) の方針（カタカナ語を漢語へ）とは **逆方向**（日本語独自概念を翻訳しない）の独立した思考。
- [大整輪](wiki/concepts/utagawa/大整輪.md) — 本人輪郭 [K#F85E/E74C-2091](https://dlt.kitetu.com/KNo.F85E/E74C-2091)（2022-03-05）。日々の [整輪](wiki/concepts/utagawa/整輪.md) では追いつかない未整備輪郭を一掃する **数年規模の活動**。希哲16年（2022年）3月3日開始、希哲19年（2025年）2月13日に「黄金整輪」として再始動。
- [整清](wiki/concepts/utagawa/整清.md) — 本人輪郭 [K#F85E/4686-193C](https://dlt.kitetu.com/KNo.F85E/4686-193C)（2018-07-24）。整理整頓・清掃を統合した造語（最初「整掃」→3日後に「整清」に改称）。**3S** の漢字表現。[副日記](wiki/concepts/utagawa/副日記.md) の一種「整清記録」として運用。
- [デライト市場戦略](wiki/concepts/utagawa/デライト市場戦略.md) — 本人輪郭 [K#F85E/5B28-3631](https://dlt.kitetu.com/KNo.F85E/5B28-3631)（2020-05-16）。**第一次〜第七次** の戦略系譜（対 Roam Research → 知能増幅メモサービス → 新生デライト → Markdown 対抗 → KNS による Twitter 対抗 → 重用者化 → 希哲黄金市場戦略）。

### 既存ページの増補

- [一日一文](wiki/concepts/utagawa/一日一文.md) — 長文越省 [『あえて政治を語ることの大切さ』](https://dlt.kitetu.com/KNo.F85E/0758-0957)（2026-02-09, 3,338字）を主要作品表に追加。「政治的無垢幻想」「政治的中立幻想」「政治知」「明朗政談」「直線型綱引き政談」「人字型綱引き政談」「揚保（アウフヘーベン 訳語）」「一夜革命への日々」編 などの新出概念を要点として整理。これらは未だ単独 concept ページ化していないため、要再訪事項として明記。「[市場施策（マーケティング）について考える」編](https://dlt.kitetu.com/KNo.F85E/0758-B628) を編成単位例に追加。
- [副日記](wiki/concepts/utagawa/副日記.md) — 15 種類のサブ記録のうち [整清](wiki/concepts/utagawa/整清.md) を新規 concept としてリンク化。睡眠記録に本人輪郭への参照を追加（「就床／覚醒／起床」の区別など細かい命名規則あり）。

### index.md 構造変更

- N. カテゴリに [大整輪](wiki/concepts/utagawa/大整輪.md), [整清](wiki/concepts/utagawa/整清.md) を追加。
- 新カテゴリ **O. 市場戦略・思想** を新設し [デライト市場戦略](wiki/concepts/utagawa/デライト市場戦略.md), [自由](wiki/concepts/utagawa/自由.md) を配置。
...
- 希哲館訳語の追加例: 揚保（アウフヘーベン）、間成し（マナー）、流例（ルール）、候り（サービス）— [希哲館訳語](wiki/concepts/utagawa/希哲館訳語.md) のリストに統合可能。
...
- [CLAUDE.md](CLAUDE.md) のディレクトリ構成と「新規ページをどこに置くか」表に追加。

### 新規統合解説ページ

- [wiki/syntheses/宇田川氏の毎日.md](wiki/syntheses/宇田川氏の毎日.md) — 第一弾。『希哲日記』, 副日記 15 種, 整輪/大整輪/日記準備整輪, 一日一文/越省/書了, 朝の定時執務, 黄金朝食, 完全メイト を **1 つの生活システム** として整理。「黄金」プレフィックスと「希哲N年」紀年法の解読キーも収録。「ほとんど特筆すべきことのない希哲黄金休日」のような本人輪郭の典型文を、特殊用語抜きで「今日も理想的な休日だった」と読み解けるところまで導く。

### 補完作成

- [wiki/concepts/utagawa/朝の定時執務.md](wiki/concepts/utagawa/朝の定時執務.md) — 統合解説ページからの参照を解消するため作成。本人輪郭 [K#F85E/0758-6162](https://dlt.kitetu.com/KNo.F85E/0758-6162) の 150 字 を整理。
...
- 「**宇田川氏の認知観**」統合解説 — 輪郭 + 認知対象 + 高度非言語思考 + 論理共感覚 + FPN + 大脳検地 を、ジェンドリン哲学との並行関係を踏まえて整理（[wiki/people/ジェンドリン.md](wiki/people/ジェンドリン.md) との連携）。
...
- [越省](wiki/concepts/utagawa/越省.md) — エッセーの [希哲館訳語](wiki/concepts/utagawa/希哲館訳語.md)。**「内省を越えて表現を試みる」** の語感を込めた造語で、宇田川氏の [一日一文](wiki/concepts/utagawa/一日一文.md) の正式名称として採用されている。本人輪郭 [K#F85E/0758-E363](https://dlt.kitetu.com/KNo.F85E/0758-E363) で「希哲館訳語が生み出した日本語における発明の一つ」「**雑文から越省へ**、という一日一文の変革像を作ってくれた翻訳語」と述べる。
- [我由](wiki/concepts/utagawa/我由.md) — 本人輪郭 [K#F85E/C1BC](https://dlt.kitetu.com/KNo.F85E/C1BC)（2012-05-20）。「[自由](wiki/concepts/utagawa/自由.md)」の第三の意味＝ **causa sui（自己原因）** だけを取り出した造語。「第三の自由」とも。スピノザの causa sui を念頭に置きつつ、「自由」から字義を変えないまま区別できる事を重視。
- [黄金](wiki/concepts/utagawa/黄金.md) — 本人輪郭 [K#F85E/0758-450D](https://dlt.kitetu.com/KNo.F85E/0758-450D)（2025-02-13）。「**宇田川の理想**」を意味する接頭辞。[ジパング計画](wiki/concepts/utagawa/ジパング計画.md)（希哲11年）以後、「知の黄金郷」を連想させる表現として多用。**黄金人種・黄金日・黄金週・黄金状態・希哲黄金期・希哲黄金市場戦略** など多数の派生語を生む。日々の日記で頻出する評価語の解読キー。

### 既存ページの増補

- [一日一文](wiki/concepts/utagawa/一日一文.md) — 「雑文から越省へ」の **2026 年の変革** を本文に追加。本人越省 [『越省（^エッセー）としての一日一文』](https://dlt.kitetu.com/KNo.F85E/0758-E363) の引用で、長文越省 [『Collabox 再改称』](https://dlt.kitetu.com/KNo.F85E/0758-475D) [『あえて政治を語ることの大切さ』](https://dlt.kitetu.com/KNo.F85E/0758-0957) が 2025-2026 年に集中している背景を説明。
- [自由](wiki/concepts/utagawa/自由.md) — [我由](wiki/concepts/utagawa/我由.md) への相互参照を追加。

### index.md の更新

- N. カテゴリに [越省](wiki/concepts/utagawa/越省.md) を追加。
- O. カテゴリに [我由](wiki/concepts/utagawa/我由.md), [黄金](wiki/concepts/utagawa/黄金.md) を追加。

### 第四波の解読価値

「黄金」は宇田川氏の日記読解のキーになる重要なメタ概念だった。「黄金日」「黄金休日」「希哲黄金市場戦略」など、本人輪郭で頻出する語は、すべて「**宇田川の理想形**」という意味の派生語であることが [K#F85E/0758-450D](https://dlt.kitetu.com/KNo.F85E/0758-450D) で明示されている。これを知らずに日記を読むと「黄金日って何の日？」となるが、知っていれば「今日は理想的に過ごせた日」程度に読み解ける。
